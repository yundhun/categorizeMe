...
def main(argv):
  ...
  f_in = open('/Users/dhyun/Desktop/exp.csv', 'r')
  csv_in = csv.reader(f_in)
  f_out = open('/Users/dhyun/Desktop/88888.csv', 'w')
  csv_out = csv.writer(f_out)

  #opts.assoc_testdata = True
  if opts.assoc_testdata:
    ...
    GenAssocTestdata(
        params1, params2, irr_rand, 20, csv_in, csv_out)
  else:
